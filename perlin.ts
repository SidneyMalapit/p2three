...
console.log(perlin.getValue(0.1));
console.log(perlin.getValue(0.2));
console.log(perlin.getValue(0.3));
console.log(perlin.getValue(0.4));
console.log(perlin.getValue(0.5));
